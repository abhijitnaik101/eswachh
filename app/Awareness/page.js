...
const Awareness = () => {
    return(
        <>
<main>
    <div className="flex justify-start mt-2 mx-64">
         {/* <img className="h-80 w-72 mx-4" src="https://imgs.search.brave.com/BLaF26YK8CL27ziHVCbS-wBjlJKfarLHznCTO4TedHI/rs:fit:860:0:0/g:ce/aHR0cHM6Ly9pLnBp/bmltZy5jb20vb3Jp/Z2luYWxzLzhiL2Rl/LzIyLzhiZGUyMmNj/MDI0OWEwMTViY2Q3/YTM1MGE3YmI5MDMy/LS16ZXJvLXdhc3Rl/LXRveXMuanBn" alt=""/>  */}
        {/* <img className="h-80 w-80 mx-72" src="https://imgs.search.brave.com/__sJU33q4SXYXfYulCmgbAYnxutTVpy1Ui6aAc_MV_M/rs:fit:860:0:0/g:ce/aHR0cHM6Ly9zdC5k/ZXBvc2l0cGhvdG9z/LmNvbS8xMDEwNzEw/LzMzODUvaS82MDAv/ZGVwb3NpdHBob3Rv/c18zMzg1MDc1My1z/dG9jay1waG90by13/YXN0ZS1yZWN5Y2xp/bmctbWFjaGluZS5q/cGc" alt=""/> */}
        <img src="/aware1.png"/>
        <img src="/aware2.png"/>
    </div>
    ...
    <div className="mx-16 mt-8">
        <h2 className="font-semibold text-2xl ">How it affects our environment?</h2>
            <div className="flex mt-6 bg-green-200">
                ...
                <img className="h-80 mt-2 pt-10 p-5 ml-4" src="https://imgs.search.brave.com/vHWObO7Gl3VG3TzIQg9t9Qyxj1JaGg2oe9v4KvYY5iA/rs:fit:860:0:0/g:ce/aHR0cHM6Ly9yZWN5/Y2xlY29hY2guY29t/L3dwLWNvbnRlbnQv/dXBsb2Fkcy8yMDIx/LzA4L2lTdG9jay0x/MTY3NjY4MTIzLTEw/MjR4NjM3LmpwZw" alt=""/>
            </div>
    </div>
    <div className='flex justify-center items-center'>
                <div className="bg-slate-900 h-[460px] w-full flex justify-center items-start pt-20">
